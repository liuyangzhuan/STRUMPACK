...
nmpi=8
srun -N 1 -n 8 -c 2 --cpu_bind=cores ${EXEC} ${DATA} 784 ${h} ${lambda} 1 2means test \
--hss_leaf_size ${LEAF} --hss_rel_tol ${ACC} --hss_compression_algorithm original --hss_d0 128 --hss_max_rank 1024 2>&1 | tee -a mnist_kernel10K.out8
