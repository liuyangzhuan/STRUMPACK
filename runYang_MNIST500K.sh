...
export DATA=/project/projectdirs/m2957/liuyangz/my_research/ML/MNIST_Origin/mnist_500Kn
...
nmpi=32
srun -N 1 -n 32 -c 2 --cpu_bind=cores ${EXEC} ${DATA} 784 ${h} ${lambda} 1 2means test \
--hss_leaf_size ${LEAF} --hss_rel_tol ${ACC} --hss_compression_algorithm original --hss_d0 128 --hss_max_rank 1024 2>&1 | tee -a mnist_kernel500K.out32
